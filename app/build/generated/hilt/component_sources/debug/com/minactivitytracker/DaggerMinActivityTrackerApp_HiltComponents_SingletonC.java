...
import com.minactivitytracker.di.DatabaseModule_ProvideAppDatabaseFactory;
...
import com.minactivitytracker.ui.export.ExportViewModel;
...
public final class DaggerMinActivityTrackerApp_HiltComponents_SingletonC {
  private DaggerMinActivityTrackerApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public MinActivityTrackerApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements MinActivityTrackerApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements MinActivityTrackerApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements MinActivityTrackerApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements MinActivityTrackerApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements MinActivityTrackerApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements MinActivityTrackerApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements MinActivityTrackerApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MinActivityTrackerApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends MinActivityTrackerApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends MinActivityTrackerApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends MinActivityTrackerApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends MinActivityTrackerApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends MinActivityTrackerApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.minactivitytracker.ui.applist.AppListViewModel 
          return (T) new AppListViewModel(singletonCImpl.activityRepositoryProvider.get());

          case 1: // com.minactivitytracker.ui.export.ExportViewModel 
          return (T) new ExportViewModel(singletonCImpl.activityRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
  ...
  private static final class ActivityRetainedCImpl extends MinActivityTrackerApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends MinActivityTrackerApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends MinActivityTrackerApp_HiltComponents.SingletonC {
    ...
    private AppSessionDao appSessionDao() {
      return DatabaseModule_ProvideAppSessionDaoFactory.provideAppSessionDao(provideAppDatabaseProvider.get());
    }

    private DeviceEventDao deviceEventDao() {
      return DatabaseModule_ProvideDeviceEventDaoFactory.provideDeviceEventDao(provideAppDatabaseProvider.get());
    }
    ...
    @Override
    public void injectMinActivityTrackerApp(MinActivityTrackerApp minActivityTrackerApp) {
      injectMinActivityTrackerApp2(minActivityTrackerApp);
    }
    ...
    private MinActivityTrackerApp injectMinActivityTrackerApp2(MinActivityTrackerApp instance) {
      MinActivityTrackerApp_MembersInjector.injectWorkerFactory(instance, hiltWorkerFactory());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.minactivitytracker.repository.ActivityRepository 
          return (T) new ActivityRepository(singletonCImpl.appSessionDao(), singletonCImpl.deviceEventDao());
