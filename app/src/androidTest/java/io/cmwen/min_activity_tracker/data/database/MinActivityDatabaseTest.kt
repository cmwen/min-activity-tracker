...
class MinActivityDatabaseTest {
    ...
    @Test
    fun getSessionsInRange_returnsCorrectSessions() = runTest {
        // Given
    ...
    @Test
    fun getAllSessionsFlow_emitsUpdates() = runTest {
        // Given
        val session1 = createTestSession("session1", 1000L, 2000L)
    ...
    @Test
    fun deleteOldSessions_removesOnlyOldSessions() = runTest {
        // Given
    ...
    @Test
    fun insertBatterySample_andRetrieve() = runTest {
        // Given
    ...
    @Test
    fun getAverageBatteryLevel_calculatesCorrectly() = runTest {
        // Given
    ...
    @Test
    fun insertDeviceEvent_andRetrieve() = runTest {
        // Given
    ...
    @Test
    fun getEventsByType_filtersCorrectly() = runTest {
        // Given
    ...
    @Test
    fun insertAnalysisReport_andRetrieve() = runTest {
        // Given
    ...
    @Test
    fun getReportsByType_filtersCorrectly() = runTest {
        // Given
    ...
    @Test
    fun transactionRollback_onError() = runTest {
        // Given
