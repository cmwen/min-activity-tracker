...
class AnalysisReportRepositoryImpl(
    ...
    override fun observeReportsByType(reportType: String): Flow<List<AnalysisReportEntity>> = dao.getReportsByType(reportType)

    override fun observeRecentReports(startTime: Long): Flow<List<AnalysisReportEntity>> = dao.getRecentReports(startTime)
