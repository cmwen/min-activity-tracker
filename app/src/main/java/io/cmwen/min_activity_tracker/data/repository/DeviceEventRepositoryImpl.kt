...
class DeviceEventRepositoryImpl(
    ...
    override fun observeEventsByType(type: String): Flow<List<DeviceEventEntity>> = dao.getEventsByType(type)

    override fun observeEventsByTimeRange(
        startTime: Long,
        endTime: Long,
    ...
    override suspend fun getEventsInRange(
        startTime: Long,
        endTime: Long,
    ): List<DeviceEventEntity> = dao.getEventsInRange(startTime, endTime)
