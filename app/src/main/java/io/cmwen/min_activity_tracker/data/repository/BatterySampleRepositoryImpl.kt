...
class BatterySampleRepositoryImpl(
    ...
    override fun observeSamplesByTimeRange(startTime: Long, endTime: Long): Flow<List<BatterySampleEntity>> = 
        dao.getSamplesByTimeRange(startTime, endTime)
    
    override fun observeSamplesByChargingState(chargingState: String): Flow<List<BatterySampleEntity>> = 
        dao.getSamplesByChargingState(chargingState)
    
    override fun observeRecentSamples(limit: Int): Flow<List<BatterySampleEntity>> = 
    ...
    override suspend fun getAverageBatteryLevel(startTime: Long, endTime: Long): Double? = 
        dao.getAverageBatteryLevel(startTime, endTime)
}
