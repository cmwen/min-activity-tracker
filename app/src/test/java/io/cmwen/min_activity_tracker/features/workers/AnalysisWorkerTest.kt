...
class AnalysisWorkerTest {
    ...
    @Test
    fun `AnalysisWorker generates report with correct data`() = runTest {
        // Given
    ...
    @Test
    fun `WorkScheduler schedules data collection successfully`() {
        // Given
    ...
    private fun createSession(packageName: String, duration: Long): AppSessionEntity {
