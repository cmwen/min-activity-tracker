...
class SessionsViewModelTest {
    ...
    @Test
    fun `sessions StateFlow initializes with empty list`() = runTest {
        // Given/When
    ...
    @Test
    fun `add calls repository insert`() = runTest {
        // Given
        val testSession = AppSessionEntity(
            id = "1",
    ...
    @Test
    fun `remove calls repository deleteById`() = runTest {
        // Given
        val testId = "test-id"
